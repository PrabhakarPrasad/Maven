...
public class RagistrationPage extends TestBase {
	...
	public void RegistrationPage(String FName,String LName,String Email,
			String PNo,String Adress,String City,String State,String PostCode,String WhatsAppNo,
			String PWord,String CPword,String ImageText){
		LoginLink.click();
